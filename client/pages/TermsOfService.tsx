          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-invert max-w-none">
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">1. Acceptance of Terms</h2>
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">2. Description of Service</h2>
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">3. Use License</h2>
                <p className="text-scout-text-muted mb-4">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">4. Disclaimer</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">5. Limitations</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">6. Accuracy of Materials</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">7. Links</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">8. Modifications</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">9. Governing Law</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">10. Confidentiality</h2>
                <p className="text-scout-text-muted mb-4">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">11. Compliance and Ethics</h2>
                <p className="text-scout-text-muted mb-4">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">12. Force Majeure</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">13. Severability</h2>
                <p className="text-scout-text-muted mb-8">
                  If any provision of these terms is found to be unenforceable or invalid, that provision will be limited or eliminated to the minimum extent necessary so that these terms will otherwise remain in full force and effect and enforceable.
                </p>

                <h2 className="text-3xl font-bold text-scout-text-white mb-6">14. Contact Information</h2>
                <p className="text-scout-text-muted mb-4">
