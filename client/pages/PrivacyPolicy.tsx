          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-invert max-w-none">
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">1. Introduction</h2>
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">2. Information We Collect</h2>
                <h3 className="text-xl font-bold text-scout-text-white mb-4">2.1 Personal Information</h3>
                <p className="text-scout-text-muted mb-4">
                  We may collect personal information that you voluntarily provide to us, including:
                </p>
                <ul className="list-disc list-inside text-scout-text-muted mb-8 space-y-2">
                ...
                <h3 className="text-xl font-bold text-scout-text-white mb-4">2.2 Automatically Collected Information</h3>
                <p className="text-scout-text-muted mb-4">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">3. How We Use Your Information</h2>
                <p className="text-scout-text-muted mb-4">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">4. Information Sharing and Disclosure</h2>
                <p className="text-scout-text-muted mb-4">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">5. Data Security</h2>
                <p className="text-scout-text-muted mb-8">
                  We implement appropriate technical and organizational security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the internet or electronic storage is 100% secure.
                </p>

                <h2 className="text-3xl font-bold text-scout-text-white mb-6">6. Data Retention</h2>
                <p className="text-scout-text-muted mb-8">
                  We retain your personal information only for as long as necessary to fulfill the purposes outlined in this Privacy Policy, unless a longer retention period is required or permitted by law.
                </p>

                <h2 className="text-3xl font-bold text-scout-text-white mb-6">7. Your Rights</h2>
                <p className="text-scout-text-muted mb-4">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">8. Cookies and Tracking Technologies</h2>
                <p className="text-scout-text-muted mb-8">
                  We use cookies and similar tracking technologies to enhance your experience on our website. You can control cookie settings through your browser preferences.
                </p>

                <h2 className="text-3xl font-bold text-scout-text-white mb-6">9. Third-Party Links</h2>
                <p className="text-scout-text-muted mb-8">
                ...
                <h2 className="text-3xl font-bold text-scout-text-white mb-6">10. International Data Transfers</h2>
                <p className="text-scout-text-muted mb-8">
                  Your information may be transferred to and processed in countries other than your own. We ensure appropriate safeguards are in place to protect your information in accordance with this Privacy Policy.
                </p>

                <h2 className="text-3xl font-bold text-scout-text-white mb-6">11. Changes to This Privacy Policy</h2>
                <p className="text-scout-text-muted mb-8">
                  We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last updated" date.
                </p>

                <h2 className="text-3xl font-bold text-scout-text-white mb-6">12. Contact Us</h2>
                <p className="text-scout-text-muted mb-4">
